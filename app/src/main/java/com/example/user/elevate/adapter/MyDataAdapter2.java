...
public class MyDataAdapter2 extends ArrayAdapter<MyDataModel> {
    ...
    // Constructors
    public MyDataAdapter2(Context context, List<MyDataModel> objects) {
